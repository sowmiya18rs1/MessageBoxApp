...
{
    QMessageBox::information(this,"SOWMIYA 212218108054","This is information");
}
...
{
    QMessageBox::StandardButton reply;
          reply = QMessageBox::question(this, "SOWMIYA", "Do you play soccer?", QMessageBox::Yes|QMessageBox::No);
